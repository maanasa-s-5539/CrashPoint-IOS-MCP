...
Run `setup_folders` (MCP tool) or `node dist/cli.js setup` to create this structure. `run_full_pipeline` and `run_basic_pipeline` will also auto-create it on first run.
